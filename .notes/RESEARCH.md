...
- Cloudflare Worker static assets need `assets.not_found_handling = "single-page-application"` for SPA fallback and `assets.run_worker_first` for `/api/*` and `/auth/oura/*`.
